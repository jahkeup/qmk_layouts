...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,TT(2),CTL_T(KC_TAB),KC_Q,KC_W,KC_E,KC_R,KC_T,TT(1),KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,CTL_T(KC_Z),KC_X,KC_C,KC_V,GUI_T(KC_B),SCMD_T(KC_LBRACKET),LT(1,KC_GRAVE),KC_QUOTE,TT(2),KC_LEFT,ALT_T(KC_RIGHT),ALT_T(KC_APPLICATION),KC_LGUI,KC_HOME,KC_SPACE,KC_LCTL,KC_END,OSL(2),KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,OSL(1),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,GUI_T(KC_QUOTE),SCMD_T(KC_RBRACKET),GUI_T(KC_N),KC_M,KC_COMMA,KC_DOT,RCTL_T(KC_SLASH),KC_RSHIFT,ALT_T(KC_UP),KC_DOWN,KC_LBRACKET,KC_RBRACKET,MO(1),KC_LALT,CTL_T(KC_ESCAPE),KC_PGUP,KC_PGDOWN,MEH_T(KC_NO),KC_ENTER),
